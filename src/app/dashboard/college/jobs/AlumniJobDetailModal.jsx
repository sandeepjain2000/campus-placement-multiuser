  ...
  return (
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="college-alumni-job-detail-title"
        style={{
      ...
      >
        ...
        >
          <div style={{ minWidth: 0 }}>
            ...
            <h2 id="college-alumni-job-detail-title" style={{ margin: 0, fontSize: '1.25rem', fontWeight: 800, letterSpacing: '-0.02em' }}>
              {row.title}
            </h2>
        ...
        >
          ...
          <div style={{ display: 'inline-flex', gap: '0.5rem', flexWrap: 'wrap', marginLeft: 'auto' }}>
            ...
            {canApprove ? (
              <button type="button" className="btn btn-primary btn-sm" disabled={busy} onClick={() => onApprove?.(row.id)}>
