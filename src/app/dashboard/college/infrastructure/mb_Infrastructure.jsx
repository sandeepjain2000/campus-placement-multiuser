...
export default function mb_Infrastructure() {
  ...
  return <>
      <MobileHeader title="Infrastructure" action={<Button type="button" onClick={() => {
      ...
      padding: '1rem 1rem 5rem 1rem'
        ...
        border: '1px solid var(--primary-300)'
            ...
            gap: '0.75rem'
              ...
              <AdminFilterSelect
                ...
                items={[
                  { label: assets.length === 0 ? 'Add a resource above first' : '-- Select Room --', value: 'all' },
                  ...assets.map((a) => ({
                    label: `${a.name} (Cap: ${a.capacity ?? '—'})`,
                    value: a.id,
                  })),
                ]}
              />
              <Input placeholder="Event / Company Name" value={company} onChange={e => setCompany(e.target.value)} />
              ...
              <Input placeholder="Remarks (optional)" value={description} onChange={e => setDescription(e.target.value)} />
              <Button type="submit" style={{
              width: '100%',
              marginTop: '0.5rem'
            }}>Reserve Resource</Button>
            </form>
          </CardContent></Card>}
        ...
        gap: '0.75rem'
          ...
          </div> : bookings.length === 0 ? <Card style={{
        textAlign: 'center',
        padding: '2rem 1rem'
      }}><CardContent>
        ...
        gap: '0.75rem'
            ...
            {bookings.map(b => <Card key={b.id} style={{
          padding: '1rem',
          position: 'relative'
        }}><CardContent>
                <div style={{
      ...
      <ConfirmDialog open={Boolean(cancelTargetId)} title="Cancel Booking" message="Are you sure you want to cancel this infrastructure booking?" confirmLabel="Cancel Booking" onCancel={() => setCancelTargetId(null)} onConfirm={async () => {
