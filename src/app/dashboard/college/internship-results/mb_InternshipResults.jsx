...
export default function mb_InternshipResults() {
  ...
  return <>
      ...
      padding: '1rem 1rem 5rem 1rem'
        ...
        {isLoading ? <PageLoading message="Loading internship results…" variant="skeleton-list" inline /> : error ? <Card style={{
        padding: '1rem',
        ...
        textAlign: 'center'
            ...
            <p style={{
            margin: 0
          }}>{error.message || 'Could not load internship results.'}</p>
          </CardContent></Card> : <>
            <div style={{
          display: 'grid',
          ...
          marginBottom: '1.25rem'
            ...
            <Card className="mb-4">
              <CardContent className="grid gap-3 py-4">
                ...
                />
                <AdminFilterSelect
                  id="mb-internship-results-company"
                  value={companyId}
                ...
                />
                <AdminFilterSelect
                  id="mb-internship-results-internship"
                  value={jobId}
                  onValueChange={setJobId}
                  className="w-full"
                  items={[
                    { label: 'All internships', value: 'all' },
                    ...uniqueInternships.map((j) => ({ label: j.title, value: String(j.id) })),
                  ]}
                />
                <div className="grid grid-cols-2 gap-2">
                  <AdminFilterSelect
                    id="mb-internship-results-status"
                    value={statusFilter}
                  ...
                  />
                  <AdminFilterSelect
                    id="mb-internship-results-branch"
                    value={branchFilter}
          ...
          gap: '0.75rem'
                ...
                {filtered.map(row => <Card key={row.id} style={{
            padding: '1rem'
          }}><CardContent>
                    <div style={{
                display: 'flex',
              ...
              }}>{row.openingTitle}</div>
                    <CompanyNameLink name={row.companyName} website={row.website} style={{
                fontSize: '0.85rem'
              }} />
                    <div style={{
                fontSize: '0.75rem',
