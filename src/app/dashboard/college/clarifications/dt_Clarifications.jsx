...
import { Search, ChevronDown, ChevronUp, MessageSquare, Building2, Download, FileText, Lightbulb } from 'lucide-react';
...
export default function CollegeClarificationsPage() {
  ...
  useEffect(() => {
    ...
    let results = q ? batches.filter(b => String(b.company || '').toLowerCase().includes(q) || Array.isArray(b.questions) && b.questions.some(qn => String(qn.text || '').toLowerCase().includes(q))) : [...batches];
    if (sortBy === 'name') {
  ...
  return <div className="animate-fadeIn" style={{
    ...
    paddingBottom: '3rem'
      ...
      <div className="mb-6 flex flex-wrap items-start justify-between gap-4" style={{
      marginBottom: '1.5rem'
    }}>
      ...
      alignItems: 'center'
        ...
        flex: 1
          ...
          <Input type="text" value={search} onChange={e => setSearch(e.target.value)} placeholder="Search companies or questions…" style={{
          paddingLeft: '2.5rem',
          borderRadius: '999px',
        ...
        flexShrink: 0
          ...
          <button type="button" onClick={() => setSortBy('date')} style={{
          ...
          <button type="button" onClick={() => setSortBy('name')} style={{
          padding: '0.35rem 0.85rem',
          borderRadius: '999px',
          fontSize: '0.8rem',
          fontWeight: 500,
          ...
          transition: 'border-color 0.2s'
              ...
              background: 'var(--surface)'
                ...
                flexWrap: 'wrap'
                  ...
                  alignItems: 'center',
                  gap: '0.4rem'
                }} onClick={() => exportAsText(batch)} variant="outline">
                  ...
                  alignItems: 'center',
                  gap: '0.4rem'
                }} onClick={() => exportAsCsv(batch)} variant="outline">
                ...
                gap: '1.25rem'
                      ...
                      {questions.map((q, idx) => <div key={q.id} style={{
                  display: 'flex',
                  flexDirection: 'column',
                  gap: '0.75rem'
                }}>
      ...
      alignItems: 'flex-start'
        ...
        <Lightbulb size={18} color="var(--warning-500, #f59e0b)" style={{
        flexShrink: 0,
        marginTop: '2px'
      }} />
        <p style={{
