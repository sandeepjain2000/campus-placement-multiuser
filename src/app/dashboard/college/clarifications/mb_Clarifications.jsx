  ...
  return <>
      ...
      padding: '1rem 1rem 5rem 1rem'
        ...
        marginBottom: '1.25rem'
          ...
          <Input placeholder="Search companies or questions..." value={search} onChange={e => setSearch(e.target.value)} style={{
          width: '100%',
          borderRadius: '999px',
          paddingLeft: '2.25rem',
        ...
        gap: '0.75rem'
          ...
          </div> : filtered.length === 0 ? <Card style={{
        textAlign: 'center',
        padding: '3rem 1rem'
      }}><CardContent>
            ...
            overflow: 'hidden'
                ...
                textAlign: 'left'
                  ...
                  paddingLeft: '2.75rem'
                      ...
                      <StatusBadge style={{
                    fontSize: '0.7rem'
                  }} tone="gray">{questions.length} Qs</StatusBadge>
                      {answeredCount > 0 && <StatusBadge style={{
                    fontSize: '0.7rem'
                  }} tone="green">{answeredCount} Answered</StatusBadge>}
                    </div>
                  </button>
