...
export default function mb_Sponsorships() {
  ...
  return <>
      <MobileHeader title="Sponsorships" action={<Button onClick={downloadGuide} style={{
      padding: '0.4rem',
      ...
      padding: '1rem 1rem 5rem 1rem'
        ...
        {activeTab === 'opportunities' && <>
          ...
          scrollbarWidth: 'none'
              ...
              {tabs.map(tab => <Button key={tab} onClick={() => setActiveCat(tab)} variant={activeCat === tab ? 'default' : 'ghost'} style={{
            borderRadius: '999px',
            whiteSpace: 'nowrap',
            padding: '0.4rem 1rem',
            fontSize: '0.8rem',
          ...
          gap: '0.75rem'
                ...
                {[1, 2].map(i => <div key={i} className="skeleton" style={{
            height: 200,
            borderRadius: '12px'
          }} />)}
              </div> : error ? <Card style={{
          padding: '1rem',
          textAlign: 'center'
        }}><CardContent>
                <p style={{
              ...
              margin: 0
            }}>Failed to load sponsorship opportunities.</p>
              </CardContent></Card> : visibleLevels.length === 0 ? <Card style={{
          padding: '2rem 1rem',
          textAlign: 'center'
        }}><CardContent>
                <p style={{
                    ...
                    border: '1px solid var(--border-default)'
                      ...
                      marginBottom: '0.5rem'
                        ...
                        fontWeight: 600
                              ...
                              {tier.label && <StatusBadge style={{
                        fontSize: '0.65rem'
                      }} tone="indigo">{tier.label}</StatusBadge>}
                            </div>
                            <div style={{
                      fontSize: '1.25rem',
                      fontWeight: 800,
        ...
        {activeTab === 'payments' && <>
          ...
          gap: '0.75rem'
               ...
               {[1, 2, 3].map(i => <div key={i} className="skeleton" style={{
            height: 120,
            borderRadius: '12px'
          }} />)}
             </div> : payments.length === 0 ? <Card style={{
          textAlign: 'center',
          padding: '3rem 1rem'
        }}><CardContent>
                <Banknote size={32} style={{
              margin: '0 auto 1rem',
              opacity: 0.3
            }} />
                <div style={{
              fontWeight: 600
            }}>No payments recorded</div>
              </CardContent></Card> : <div style={{
          display: 'flex',
          flexDirection: 'column',
          gap: '0.75rem'
        }}>
                {payments.map(p => <Card key={p.id} style={{
            padding: '1rem'
          }}><CardContent>
                    <div style={{
                display: 'flex',
                ...
                marginBottom: '0.5rem'
                  ...
                  fontSize: '0.95rem'
                      ...
                      <StatusBadge style={{
                  fontSize: '0.65rem'
                }} tone="gray">{formatPaymentStatus(p.status, p.method)}</StatusBadge>
                    </div>
                ...
                marginBottom: '0.5rem'
                  ...
                  color: 'var(--success-600)'
                    ...
                    {(p.billingLegalName || p.billingPan || p.billingGstNumber) && <div style={{
                background: 'var(--bg-secondary)',
                ...
                fontSize: '0.75rem'
                  ...
                  color: 'var(--text-tertiary)'
                      ...
                      {p.receiptSent ? <span style={{
                  color: 'var(--success-600)',
                  fontWeight: 500
                }}>
                          Receipt Sent
                        </span> : <Button type="button" disabled={sendingReceiptFor === p.id} onClick={() => void sendTaxReceipt(p.id)} style={{
                  padding: '0.2rem 0.6rem',
                  fontSize: '0.7rem'
                }} variant="outline" size="sm">
                          <FileCheck2 size={12} style={{
                    marginRight: 4
                  }} />
