    ...
    <div className="animate-fadeIn">
      <div className="page-header">
        <div className="page-header-left">
          <h1>{mode === 'clarifications' ? '📋 Clarifications' : '💬 College discussions'}</h1>
          <p style={{ margin: 0 }}>
            {mode === 'clarifications' ? (
              <>
      ...
      <div className="tabs" style={{ marginBottom: '1rem' }} role="tablist" aria-label="Employer messaging">
        <Link
          href={CLARIFICATIONS_PATH}
          className={`tab ${mode === 'clarifications' ? 'active' : ''}`}
          style={{ textDecoration: 'none' }}
          role="tab"
          aria-selected={mode === 'clarifications'}
        >
          Clarifications (candidates)
        </Link>
        <Link
          href={DISCUSSIONS_PATH}
          className={`tab ${mode === 'discussions' ? 'active' : ''}`}
          style={{ textDecoration: 'none' }}
          role="tab"
