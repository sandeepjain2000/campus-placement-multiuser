-- Group tenants & student affiliation (foundation for multi-college accounts)
-- Many institutes share one administration/campus but need per-college attribution on students.
